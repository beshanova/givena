...
<h2>Результаты поиска для цвета &quot;<?=$_REQUEST['color']?>&quot;<?if ($_REQUEST['height_from']!="" || $_REQUEST['height_from']!=""):?>, высоты<?if ($_REQUEST['height_from']!=""):?> от "<?=$_REQUEST['height_from']?>"<?endif;?><?if ($_REQUEST['height_to']!=""):?> до "<?=$_REQUEST['height_to']?>"<?endif;?> см.
<?endif;?></h2>
