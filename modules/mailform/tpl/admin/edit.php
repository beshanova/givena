...
<div id="tabs">
	...
	<br>
    <div id="tabs-1">
		<div class="mailform-scroll" style="width: 980px;">
						<b>Сообщения</b><br>
						<br>
						<? if (!empty($mess)) : ?>
							<table class="mailform-scroll-table" border="0" style="border-spacing: 0px;width: 960px;">
								<tr style="font-weight: bold;">
									<td style="padding: 0 10px;"><b>ID</b></td>
									<td style="padding: 0 10px;"><b>Дата</b></td>
								<? foreach ($fields as $f) : ?>
									<td style="padding: 0 10px;"><b><?= $f['title'] ?></b></td>
								<? endforeach ; ?>
								</tr>
							<? foreach ($mess as $m) : ?>
								<tr>
									<td style="padding: 0 10px;"><?= $m['module_mailform_item_id'] ?></td>
									<td style="padding: 0 10px;"><?= $m['module_mailform_item_date_update'] ?></td>
