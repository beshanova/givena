...
class Title extends ExtController
{
    ...
    protected $app=null;
    const C_NAME = 'Title';
    const C_TITLE = 'Заголовок';
    const C_DESC = 'Заголовок';
    const C_ISPUB = 1;
    ...
    private function getContent()
    {
        ...
        return $this->ApplyTemplate($data['module_title_tpl'], array('title'=>$data['module_title_text'], 'is_active'=>$data['topics_module_is_active']), $this->getClassName());
    }
