...
<div id="tabs">
    ...
    <div id="tabs-1">
      ...
      <?if ($f['COLUMN_NAME']=='f_availability') { continue; }?>
			<tr class="<?= (preg_match('~^f_price\d?$~i', $f['COLUMN_NAME'])?'admin-tr-line-top':'') . (preg_match('~^f_p\d?_see$~i', $f['COLUMN_NAME'])?'admin-tr-line-bottom':'') ?>">
			...
			<tr>
				...
				<td><input type="checkbox" name="catalog[module_list_item_is_active]" value="1" <?= ($catalog['module_list_item_is_active'] ? 'checked' : '') ?>>
                    <input type="hidden" name="f_availability" value="1">
                </td>
			</tr>
		</table>
	  </div>
