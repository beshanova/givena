...
//                    $seen = $this->ApplyTemplate('catalog_seen_list_auth.php', array('catalog'=>$items));
                    ...
                    $content = $this->ApplyTemplate('p_orders.php', array('orders'=>$orders), $this->getClassName());
...
//                    $seen = $this->ApplyTemplate('catalog_seen_list_auth.php', array('catalog'=>$items));
                ...
                case 'pay':
                    ...
                    print $this->ApplyTemplate('/profile/p_pay30.php', array('data'=>$data));
                    exit;
