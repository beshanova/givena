...
class Templates extends ExtController
{
    ...
    public $action='';
    protected $app=null;
    const C_NAME = 'Templates';
    const C_TITLE = 'Шаблоны';
    const C_DESC = 'Шаблоны';
    const C_ISPUB = 1;
    ...
    private function getContent()
    {
        ...
        return $this->ApplyTemplate($data['module_title_tpl'], array('title'=>$data['module_title_text'],'page'=>$this->app->topic[0]['module_menu_id'],  'is_active'=>$data['topics_module_is_active']), $this->getClassName());
    }
