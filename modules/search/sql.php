...
class SearchSql extends DB
{
    ...
    function searchTextInModules($q_arr, $cnt_lit=100)
    {
        ...
        foreach ($modules as $cl=>$tm_ids)
        {
          ...
          $prices = array();
          $prices[] = ($rt['f_p_act'] && $rt['f_p_see']) ? $rt['f_price'] : '';
          $prices[] = ($rt['f_p2_act'] && $rt['f_p2_see']) ? $rt['f_price2'] : '';
          $prices[] = ($rt['f_p3_act'] && $rt['f_p3_see']) ? $rt['f_price3'] : '';
          $prices[] = ($rt['f_p4_act'] && $rt['f_p4_see']) ? $rt['f_price4'] : '';
          $rt['price_mass'] = array_filter($prices, "filter_price_mass");
